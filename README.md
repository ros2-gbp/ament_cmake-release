## ament_cmake (rolling) - 2.9.2-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake` on `Thu, 03 Sep 2026 13:56:27 -0000`
...
## ament_cmake (lyrical) - 2.8.8-1

The packages in the `ament_cmake` repository were released into the `lyrical` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release -r lyrical -t lyrical ament_cmake` on `Tue, 28 Jul 2026 16:07:01 -0000`
...
## ament_cmake (rolling) - 2.9.1-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake` on `Thu, 02 Jul 2026 09:58:09 -0000`
...
## ament_cmake (rolling) - 2.9.0-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release -r rolling -t rolling ament_cmake` on `Tue, 05 May 2026 16:33:26 -0000`
...
## ament_cmake (rolling) - 2.8.7-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake` on `Wed, 08 Apr 2026 10:50:58 -0000`
...
## ament_cmake (humble) - 1.3.14-1

The packages in the `ament_cmake` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble ament_cmake` on `Mon, 23 Feb 2026 19:31:39 -0000`
...
- upstream repository: https://github.com/ament/ament_cmake.git
- release repository: https://github.com/ros2-gbp/ament_cmake-release.git
- rosdistro version: `1.3.13-1`
- old version: `1.3.13-1`
- new version: `1.3.14-1`
...
## ament_cmake (jazzy) - 2.5.6-2

The packages in the `ament_cmake` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy ament_cmake` on `Mon, 23 Feb 2026 16:04:30 -0000`
...
## ament_cmake (jazzy) - 2.5.6-1

The packages in the `ament_cmake` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy ament_cmake` on `Mon, 23 Feb 2026 15:41:26 -0000`
...
## ament_cmake (kilted) - 2.7.5-1

The packages in the `ament_cmake` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted ament_cmake` on `Mon, 23 Feb 2026 15:29:16 -0000`
...
## ament_cmake (rolling) - 2.8.6-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake` on `Mon, 23 Feb 2026 15:16:03 -0000`
...
## ament_cmake (humble) - 1.3.13-1

The packages in the `ament_cmake` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble ament_cmake` on `Tue, 13 Jan 2026 11:46:42 -0000`
...
## ament_cmake (jazzy) - 2.5.5-1

The packages in the `ament_cmake` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy ament_cmake` on `Tue, 13 Jan 2026 11:35:39 -0000`
...
## ament_cmake (kilted) - 2.7.4-1

The packages in the `ament_cmake` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted ament_cmake` on `Tue, 13 Jan 2026 11:22:56 -0000`
...
## ament_cmake (rolling) - 2.8.5-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake` on `Tue, 13 Jan 2026 11:07:33 -0000`
...
## ament_cmake (rolling) - 2.8.4-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ament_cmake` on `Tue, 01 Jul 2025 17:03:36 -0000`
...
## ament_cmake (humble) - 1.3.12-1

The packages in the `ament_cmake` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble ament_cmake` on `Fri, 27 Jun 2025 17:53:11 -0000`
...
## ament_cmake (rolling) - 2.8.3-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake` on `Thu, 19 Jun 2025 11:54:05 -0000`
...
## ament_cmake (rolling) - 2.8.2-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling ament_cmake` on `Wed, 04 Jun 2025 16:23:20 -0000`
...
## ament_cmake (rolling) - 2.8.1-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake` on `Tue, 20 May 2025 13:11:15 -0000`
...
## ament_cmake (rolling) - 2.8.0-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release ament_cmake -r rolling` on `Thu, 24 Apr 2025 18:05:16 -0000`
...
The packages in the `ament_cmake` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy ament_cmake` on `Thu, 24 Apr 2025 09:38:32 -0000`
...
## ament_cmake (rolling) - 2.7.3-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release ament_cmake -r rolling` on `Thu, 17 Apr 2025 22:25:46 -0000`
...
The packages in the `ament_cmake` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy ament_cmake` on `Wed, 18 Dec 2024 07:07:22 -0000`
...
## ament_cmake (rolling) - 2.7.2-2

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release -r rolling ament_cmake` on `Fri, 13 Dec 2024 15:55:59 -0000`
...
## ament_cmake (jazzy) - 2.5.2-2

The packages in the `ament_cmake` repository were released into the `jazzy` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release -r jazzy ament_cmake` on `Fri, 13 Dec 2024 15:46:04 -0000`
...
The packages in the `ament_cmake` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble -y ament_cmake` on `Mon, 25 Nov 2024 17:36:58 -0000`
...
## ament_cmake (rolling) - 2.7.2-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release -r rolling ament_cmake` on `Tue, 19 Nov 2024 19:06:18 -0000`
...
## ament_cmake (iron) - 2.0.7-1

The packages in the `ament_cmake` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron ament_cmake` on `Fri, 08 Nov 2024 20:06:24 -0000`
...
## ament_cmake (rolling) - 2.7.1-1

The packages in the `ament_cmake` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ament_cmake` on `Thu, 03 Oct 2024 16:48:46 -0000`
...
The packages in the `ament_cmake` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble -y ament_cmake` on `Fri, 26 Jul 2024 13:31:04 -0000`
...
## ament_cmake (iron) - 2.0.6-1

The packages in the `ament_cmake` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron ament_cmake` on `Wed, 10 Jul 2024 19:55:06 -0000`
